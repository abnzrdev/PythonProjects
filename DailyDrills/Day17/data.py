question_data = [
    ...
    {"text": "The human brain uses about 50% of the body's total energy.", "answer": "False"},
    ...
    {"text": "There are more possible games of chess than atoms in the observable universe.", "answer": "True"},
    ...
    {"text": "Sea otters hold hands while sleeping to prevent drifting apart.", "answer": "True"}
]